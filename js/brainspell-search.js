...
function loadTemplate()
{
	...
	oReq.open("GET", "/data/colin180.img", true);
...
function fullscreen()
{
	...
	if( THREEx.FullScreen.available() ) {
		THREEx.FullScreen.request(document.getElementById('meshCanvas'));
		var container=document.getElementById('meshCanvas');
		var oldWidth=$("#meshCanvas").width();
		var oldHeight=$("#meshCanvas").height();
		var	newWidth=$(window).width();
		var	newHeight=oldHeight*newWidth/oldWidth;
		$("#meshCanvas").css("width",newWidth);
		$("#meshCanvas").css('height',newHeight);
		$("#meshCanvas").css("position","fixed");
		$("#meshCanvas").css("top","0");
		$("#meshCanvas").css("left","0");
...
{
	console.log(THREEx.FullScreen.activated());
	if(THREEx.FullScreen.activated()==true)
	{
		console.log("true");
	}
	else
	{
		console.log("false");
		var container=document.getElementById('meshCanvas');
		$("#meshCanvas").css("width",384);
		$("#meshCanvas").css('height',384);
		$("#meshCanvas").css("position","relative");
		$("#meshCanvas").css("top","0");
		$("#meshCanvas").css("left","0");
